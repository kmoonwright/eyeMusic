...
playlistA = Playlist.create(title: 'Rock Out', user_id: demoUser.id)
    pa1 = PlaylistSong.create(song_id: comeon.id, playlist_id:playlistA.id )
    pa2 = PlaylistSong.create(song_id: invaderace.id, playlist_id:playlistA.id )
    pa3 = PlaylistSong.create(song_id: runningonemptysong.id, playlist_id:playlistA.id )
    pa4 = PlaylistSong.create(song_id: struckbyawreckingball.id, playlist_id:playlistA.id )
    pa5 = PlaylistSong.create(song_id: mission.id, playlist_id:playlistA.id )
    pa6 = PlaylistSong.create(song_id: crosstowntraffic.id, playlist_id:playlistA.id )
    pa7 = PlaylistSong.create(song_id: whokilledthecheerleader.id, playlist_id:playlistA.id )

playlistB = Playlist.create(title: 'So Funky, So Fresh', user_id: demoUser.id)
    pb1 = PlaylistSong.create(song_id: whendovescry.id, playlist_id:playlistB.id )
    pb2 = PlaylistSong.create(song_id: trust.id, playlist_id:playlistB.id )
    pb3 = PlaylistSong.create(song_id: sexydancer.id, playlist_id:playlistB.id )
    pb4 = PlaylistSong.create(song_id: cafedefloresong.id, playlist_id:playlistB.id )
    pb5 = PlaylistSong.create(song_id: letsdancesong.id, playlist_id:playlistB.id )
    pb6 = PlaylistSong.create(song_id: instantcrush.id, playlist_id:playlistB.id )
    pb7 = PlaylistSong.create(song_id: aroundtheworld.id, playlist_id:playlistB.id )

playlistC = Playlist.create(title: 'Chillin', user_id: demoUser.id)
    pc1 = PlaylistSong.create(song_id: cafedefloresong.id, playlist_id:playlistC.id )
    pc2 = PlaylistSong.create(song_id: livinginaboxsong.id, playlist_id:playlistC.id )
    pc3 = PlaylistSong.create(song_id: goodtime.id, playlist_id:playlistC.id )
    pc4 = PlaylistSong.create(song_id: letsdancesong.id, playlist_id:playlistC.id )
    pc5 = PlaylistSong.create(song_id: instantcrush.id, playlist_id:playlistC.id )
    pc6 = PlaylistSong.create(song_id: aquietmansong.id, playlist_id:playlistC.id )

playlistD = Playlist.create(title: 'Kramerica Industries', user_id: demoUser.id)
    pd1 = PlaylistSong.create(song_id: diegedakensindfrei.id, playlist_id:playlistD.id )
    pd2 = PlaylistSong.create(song_id: nevermetagerman.id, playlist_id:playlistD.id )
    pd3 = PlaylistSong.create(song_id: livinginaboxsong.id, playlist_id:playlistD.id )
    pd4 = PlaylistSong.create(song_id: goodtime.id, playlist_id:playlistD.id )
    pd5 = PlaylistSong.create(song_id: letsdancesong.id, playlist_id:playlistD.id )
    pd6 = PlaylistSong.create(song_id: instantcrush.id, playlist_id:playlistD.id )
    pd7 = PlaylistSong.create(song_id: aquietmansong.id, playlist_id:playlistD.id )
    pd8 = PlaylistSong.create(song_id: allrightsong.id, playlist_id:playlistD.id )
...
playlistF = Playlist.create(title: "80's Playlist", user_id: demoUser.id)
    ...
    pf5 = PlaylistSong.create(song_id: trust.id, playlist_id:playlistF.id )
...
playlistG = Playlist.create(title: "Hidden Gems", user_id: demoUser.id)
    ...
    pg5 = PlaylistSong.create(song_id: mypatch.id, playlist_id:playlistG.id )
    pg6 = PlaylistSong.create(song_id: allrightsong.id, playlist_id:playlistG.id )
...
playlistH = Playlist.create(title: "Electronic", user_id: demoUser.id)
    ...
    ph4 = PlaylistSong.create(song_id: somethingaboutus.id, playlist_id:playlistH.id )